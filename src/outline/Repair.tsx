    ...
    return (
      ...
      >
        ...
        <path
          ...
          stroke-linejoin="round"
        ></path>
        <path d="M7.98999 2V7" stroke="#000929" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
        <path d="M12 2V4" stroke="#000929" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
      </svg>
    )
  },
)
