    ...
    return (
      ...
      >
        ...
        <path
          ...
          strokeLinejoin="round"
        ></path>
        <path d="M7.98999 2V7" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
        <path d="M12 2V4" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
      </svg>
    )
  },
)
