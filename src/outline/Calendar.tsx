    ...
    return (
      ...
      >
        ...
        <path
          ...
          strokeLinejoin="round"
        ></path>
        <path d="M16.0438 2V5.29078" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
        <path d="M7.96552 2V5.29078" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
        <path
          fillRule="evenodd"
          clipRule="evenodd"
