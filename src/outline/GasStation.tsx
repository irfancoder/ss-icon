    ...
    return (
      ...
      >
        <path
          ...
          strokeLinejoin="round"
        ></path>
        <path d="M2 22H19" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
        <path
          ...
          strokeLinejoin="round"
        ></path>
        <path d="M6.5 13H9.5" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
        <path
