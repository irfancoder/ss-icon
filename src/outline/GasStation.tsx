  ...
  ({ className, color = "currentColor", size = 16, ...rest }, ref) => {
    return (
      ...
      >
        ...
        ></path>
        <path d="M2 22H19" stroke={color} stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
        <path
          ...
          stroke-linejoin="round"
        ></path>
        <path d="M6.5 13H9.5" stroke={color} stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
        <path
