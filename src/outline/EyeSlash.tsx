...
const EyeSlash: FunctionComponent<EyeSlashProps> = forwardRef<SVGSVGElement, EyeSlashProps>(
    ...
    return (
      ...
      >
        ...
        <path
          ...
          strokeLinejoin="round"
        ></path>
        <path d="M9.47 14.53L2 22" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
        <path d="M22 2L14.53 9.47" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
      </svg>
    )
  },
)
