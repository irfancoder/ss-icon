...
const Tips: FunctionComponent<TipsProps> = forwardRef<SVGSVGElement, TipsProps>(
  ({ className, color = "currentColor", size = 16, ...rest }, ref) => {
    return (
      ...
      >
        <path
          d="M12 7.88989L10.93 9.74989C10.69 10.1599 10.89 10.4999 11.36 10.4999H12.63C13.11 10.4999 13.3 10.8399 13.06 11.2499L12 13.1099"
          stroke={color}
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
