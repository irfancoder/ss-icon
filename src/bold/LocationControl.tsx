...
const LocationControl: FunctionComponent<LocationControlProps> = forwardRef<SVGSVGElement, LocationControlProps>(
  ({ className, color = "currentColor", size = 16, ...rest }, ref) => {
    return (
      <svg
        ...
        {...rest}
      >
        <g clip-path="url(#clip0_222_6026)">
          <path
          ...
          <path
            ...
            stroke-linejoin="round"
          ></path>
          <path d="M12 11V11.01" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
        </g>
        <defs>
